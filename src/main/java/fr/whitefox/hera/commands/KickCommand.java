    ...
    public boolean onCommand(CommandSender sender, Command cmd, String msg, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("kick")) {
            ...
            if (sender instanceof Player) {
                ...
                if (args.length == 0) {
                    player.sendMessage(ChatColor.RED + "La commande est : /kick <pseudo> {raison}");
                }
                ...
                if (args.length == 0) {
                    getServer().getConsoleSender().sendMessage(ChatColor.RED + "La commande est : /kick <pseudo> {raison}");
                }
