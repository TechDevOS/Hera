...
public class AntiVPN {
    ...
    public static void verif(Player player) {
        ...
        } else if((boolean) obj.get("hosting") && plugin.getConfig().getBoolean("antiVPN.hosting")){
            player.kickPlayer(
                    "§4§lVous avez été éjecté du serveur !" +
        ...
        } else if((boolean) obj.get("mobile") && plugin.getConfig().getBoolean("antiVPN.4G")){
            player.kickPlayer(
                    "§4§lVous avez été éjecté du serveur !" +
